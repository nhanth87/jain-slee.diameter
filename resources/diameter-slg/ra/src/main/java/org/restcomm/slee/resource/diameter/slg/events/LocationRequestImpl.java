...
/**
 * Implementation of the LocationRequest interface.
 *
 * @author <a href="mailto:brainslog@gmail.com"> Alexandre Mendonca </a>
 * @author <a href="mailto:baranowb@gmail.com"> Bartosz Baranowski </a>
 */
public class LocationRequestImpl extends DiameterMessageImpl implements LocationRequest {
  ...
  protected String longMessageName = "Location-Request";
  protected String shortMessageName = "LgR";

  public LocationRequestImpl(Message message) {
    super(message);

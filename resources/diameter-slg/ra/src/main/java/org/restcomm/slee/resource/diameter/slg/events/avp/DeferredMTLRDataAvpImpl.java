...
/**
 * Implementation of AVP: {@link DeferredMTLRDataAvp} interface.
 */
public class DeferredMTLRDataAvpImpl extends GroupedAvpImpl implements DeferredMTLRDataAvp {
  ...
  public boolean hasDeferredLocationType() {
    return hasAvp(SLgAvpCodes.DEFERRED_LOCATION_TYPE, SLgAvpCodes.SLG_VENDOR_ID);
  }

  @Override
  public long getDeferredLocationType() {
    return getAvpAsUnsigned32(SLgAvpCodes.DEFERRED_LOCATION_TYPE, SLgAvpCodes.SLG_VENDOR_ID);
  }

  @Override
  public void setDeferredLocationType(long deferredLocationType) {
    addAvp(SLgAvpCodes.DEFERRED_LOCATION_TYPE, SLgAvpCodes.SLG_VENDOR_ID, deferredLocationType);
  }
  ...
  public long getTerminationCause() {
    return getAvpAsUnsigned32(Avp.TERMINATION_CAUSE);
  }

  @Override
  public void setTerminationCause(long terminationCause) {
    addAvp(Avp.TERMINATION_CAUSE, terminationCause);
  }

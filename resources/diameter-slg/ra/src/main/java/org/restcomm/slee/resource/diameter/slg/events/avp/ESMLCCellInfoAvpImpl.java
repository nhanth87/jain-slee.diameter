...
/**
 * Implementation of AVP: {@link ESMLCCellInfoAvp} interface.
 */
public class ESMLCCellInfoAvpImpl extends GroupedAvpImpl implements ESMLCCellInfoAvp {
  ...
  public boolean hasCellPortionID() {
    return hasAvp(SLgAvpCodes.CELL_PORTION_ID, SLgAvpCodes.SLG_VENDOR_ID);
  }

  @Override
  public Long getCellPortionID() {
    return (long) getAvpAsInteger32(SLgAvpCodes.CELL_PORTION_ID, SLgAvpCodes.SLG_VENDOR_ID);
  }

  @Override
  public void setCellPortionID(Long cellPortionID) {
    addAvp(SLgAvpCodes.CELL_PORTION_ID, SLgAvpCodes.SLG_VENDOR_ID, cellPortionID.intValue());
  }

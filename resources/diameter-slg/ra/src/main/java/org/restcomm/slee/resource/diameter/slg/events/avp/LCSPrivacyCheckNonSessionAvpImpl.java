...
/**
 * Implementation of AVP: {@link LCSPrivacyCheckNonSessionAvp} interface.
 */
public class LCSPrivacyCheckNonSessionAvpImpl extends GroupedAvpImpl implements LCSPrivacyCheckNonSessionAvp {
  ...
  public boolean hasLCSPrivacyCheck() {
    return hasAvp(SLgAvpCodes.LCS_PRIVACY_CHECK, SLgAvpCodes.SLG_VENDOR_ID);
  }

  @Override
  public int getLCSPrivacyCheck() {
    return getAvpAsInteger32(SLgAvpCodes.LCS_PRIVACY_CHECK, SLgAvpCodes.SLG_VENDOR_ID);
  }

  @Override
  public void setLCSPrivacyCheck(int lcsPrivacyCheck) {
    addAvp(SLgAvpCodes.LCS_PRIVACY_CHECK, SLgAvpCodes.SLG_VENDOR_ID, lcsPrivacyCheck);
  }

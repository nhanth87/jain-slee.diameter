...
/**
 * Defines an interface representing the Location-Request command.
 * 
 * From the Diameter SLg Reference Point Protocol Details (3GPP TS 29.172)
 * specification:
 * 
 * <pre>
 * 3.2.1        Location-Request (LgR) Command
 * 
 * The Location-Request command, indicated by the Command-Code field set 
 * to 8388620 and the 'R' bit set in the Command Flags field, is sent by 
 * a GMLC to an MME to request location information for a target UE.
 * 
 * Message Format
 * &lt; Location-Request &gt; ::=   &lt; Diameter Header: 8388620, REQ, PXY, 16777255 &gt;
 *                             &lt; Session-Id &gt;
 *                             { Auth-Session-State }
 *                             { Origin-Host }
 *                             { Origin-Realm }
 ...
 */
public interface LocationRequest extends DiameterMessage {

...
/**
 * Defines an interface representing the Additional-Area grouped AVP type.
 *
 * From the Diameter SLg Reference Point Protocol Details (3GPP TS 29.172):
 * <pre>
 * 7.4.48        Additional-Area
 * 
 * The Additional-Area AVP is of type Grouped.
 * 
 * AVP format
 * Additional-Area ::= <AVP header: 2549 10415>
 *                     { Area-Identification }
 *                     [ Area-Type ]
 *                     *[AVP]
 * </pre>
 ...
 */
public interface AdditionalAreaAvp extends GroupedAvp {

...
/**
 * Defines an interface representing the Positioning-Data-Info grouped AVP type.
 *
 * From the Diameter SLg Reference Point Protocol Details (3GPP TS 29.172):
 * <pre>
 * 7.4.31        Positioning-Data-Info (Grouped)
 * 
 * The Positioning-Data-Info AVP is of type Grouped and holds the information
 * about the positioning methods that were used to calculate the location estimate.
 * 
 * AVP format
 * Positioning-Data-Info ::= <AVP header: 2520 10415>
 ...
 */
public interface PositioningDataInfo extends GroupedAvp {
   ...
   * 
   * @return the value of the GERAN-Positioning-Data AVP or null if it has not been set
   */
   ...
   * 
   * @throws IllegalStateException if setGERANPositioningData has already been called
   */

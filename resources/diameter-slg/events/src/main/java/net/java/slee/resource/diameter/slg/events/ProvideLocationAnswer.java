 ...
 * 
 * <pre>
 * 3.2.4        Provide-Location-Answer (PLA) Command
 * 
 * The Provide-Location-Answer command, indicated by the Command-Code field set 
 * to 8388622 and the 'R' bit cleared in the Command Flags field, is sent by an 
 * MME to a GMLC in response to the Provide-Location-Request command.
 * 
 * Message Format
 * &lt; Provide-Location-Answer &gt; ::=        &lt; Diameter Header: 8388622, PXY, 16777255 &gt;
 *                                         &lt; Session-Id &gt;
 *                                         [ Result-Code ]
 *                                         [ Experimental-Result ]
 *                                         { Auth-Session-State }
...
public interface ProvideLocationAnswer extends DiameterMessage {
  ...
  /**
   * Returns the value of the PLA-Flags AVP, of type Unsigned32.
   * 
   * @return the value of the PLA-Flags AVP or null if it has not been set
   */
  long getPLAFlags();
   ...
   * 
   * @throws IllegalStateException if setPLAFlags has already been called
   */
  void setPLAFlags(long plaFlags);

...
/**
 * Defines an interface representing the LCS-Privacy-Check-Session grouped AVP type.
 *
 * From the Diameter SLg Reference Point Protocol Details (3GPP TS 29.172):
 * <pre>
 * 7.4.34        LCS-Privacy-Check-Session
 * 
 * The LCS-Privacy-Check-Session AVP is of type Grouped.
 * 
 * AVP format
 * LCS-Privacy-Check-Session ::= <AVP header: 2530 10415>
 *                               [ LCS-Privacy-Check ]
 *                               *[AVP]
 * </pre>
 * 

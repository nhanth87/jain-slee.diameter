...
/**
 * Implementation of the RoutingInfoAnswer interface.
 *
 * @author <a href="mailto:brainslog@gmail.com"> Alexandre Mendonca </a>
 * @author <a href="mailto:baranowb@gmail.com"> Bartosz Baranowski </a>
 */
public class RoutingInfoAnswerImpl extends DiameterMessageImpl implements RoutingInfoAnswer {

  private static final long serialVersionUID = 1L;

  protected String longMessageName = "Routing-Info-Answer";
  protected String shortMessageName = "RIA";
  ...
  public RoutingInfoAnswerImpl(Message message) {
    super(message);

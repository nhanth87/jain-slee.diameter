...
/**
 * Implementation of the RoutingInfoRequest interface.
 *
 * @author <a href="mailto:brainslog@gmail.com"> Alexandre Mendonca </a>
 * @author <a href="mailto:baranowb@gmail.com"> Bartosz Baranowski </a>
 */
public class RoutingInfoRequestImpl extends DiameterMessageImpl implements RoutingInfoRequest {

  private static final long serialVersionUID = 1L;

  protected String longMessageName = "Routing-Info-Request";
  protected String shortMessageName = "RIR";
  ...
  public RoutingInfoRequestImpl(Message message) {
    super(message);
  ...
  // GMLC-Number AVP code is 1474
  private static final int GMLC_NUMBER_AVP = 1474;

  public boolean hasGMLCNumber() {
    return hasAvp(GMLC_NUMBER_AVP, SLH_VENDOR_ID);
  }

  public byte[] getGMLCNumber() {
    return getAvpAsOctetString(GMLC_NUMBER_AVP, SLH_VENDOR_ID);
  }

  public void setGMLCNumber(byte[] gmlcNumber) {
    addAvp(GMLC_NUMBER_AVP, SLH_VENDOR_ID, gmlcNumber);
  }
